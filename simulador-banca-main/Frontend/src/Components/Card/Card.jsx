  ...
  return (
    <div className="w-full px-6 py-6 mx-auto">
      <div className="flex flex-wrap -mx-3">
                  ...
                  <div>
                    <div className="mb-2 w-12 h-12 text-center bg-beige from-blue-500 to-violet-500 rounded-md">
                      <i className="ni leading-none ni-money-coins text-lg relative top-3.5 text-white">
                        <box-icon name="credit-card" color="#0a8e4d"></box-icon>
                      </i>
                    </div>
        ...
        {/* card3 */}
        <div className="w-full max-w-full px-3 mb-6 sm:w-1/2 sm:flex-none xl:mb-0 xl:w-1/3">
          <div className="relative flex flex-col min-w-0 break-words bg-white shadow-xl dark:bg-slate-850 dark:shadow-dark-xl rounded-2xl bg-clip-border h-full">
            {" "}
