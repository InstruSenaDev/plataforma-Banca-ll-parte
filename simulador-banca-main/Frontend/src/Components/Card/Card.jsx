      ...
      <div className="flex flex-row -mx-3 items-center">
        <div className="flex-none w-2/3 max-w-full px-3">
          ...
          <div className="flex flex-col">
            <button className="mb-2 bg-green-500 hover:bg-green-600 text-white font-bold py-2 px-4 mb-2 rounded">
              Botón Verde
            </button>
            <button className="mb-2 bg-red-500 hover:bg-red-600 text-white font-bold py-2 px-4 rounded">
              Botón Rojo
            </button>
          </div>
        </div>
