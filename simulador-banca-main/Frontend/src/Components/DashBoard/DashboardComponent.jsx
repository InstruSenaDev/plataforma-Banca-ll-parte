        ...
        <>
          <div className="flex h-screen overflow-hidden bg-beige">
            ...
            <div
              ...
              } lg:flex lg:flex-col absolute lg:static z-40 left-0 top-0 lg:translate-x-0 h-screen overflow-y-scroll lg:overflow-y-auto no-scrollbar w-80 shrink-0 p-4 transition-all duration-200 ease-in-out transform`}
              aria-label="Sidebar"
            >
            ...
            {/* Content area */}
            <div className="relative flex flex-col flex-1 overflow-y-auto overflow-x-hidden m-2 lg:m-0 lg:my-4 lg:mr-4">
              <div className="h-screen border-2 border-gray-200 border-dashed rounded-lg p-2">
                {/*  Site header */}
                <header className="sticky top-0 border-b border-gray lg:mt-6">
