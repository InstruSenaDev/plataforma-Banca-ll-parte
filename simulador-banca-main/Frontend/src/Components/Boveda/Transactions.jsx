...
const Transactions = () => {
  return (
    <div className="flex flex-col lg:flex-row space-y-6 lg:space-y-0 lg:space-x-8"> {/* Contenedor de las dos cajas */}
      {/* Primera caja */}
      <div className="flex-1 max-w-2xl px-4 py-3 bg-white rounded-md shadow-md dark:bg-gray-800">
      ...
      {/* Segunda caja */}
      <div className="flex-1 max-w-2xl px-4 py-3 bg-white rounded-md shadow-md dark:bg-gray-800 lg:self-start">
