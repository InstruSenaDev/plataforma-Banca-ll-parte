...
const Transactions = () => {
  return (
    <div className="flex flex-col lg:flex-row space-y-6 lg:space-y-0 lg:space-x-8"> {/* Contenedor de las dos cajas */}
      {/* Primera caja */}
      <div className="flex-1 max-w-2x2 px-4 py-3 bg-white border border-emerald rounded-md shadow-md dark:bg-gray-800">
  ...
  <div class="w-1/2 flex flex-col justify-between items-end text-center">
    ...
    <h1 class="mt-2 text-gray-700 dark:text-gray-200"># 0001</h1>
      ...
      {/* Segunda caja */}
      <div className="flex-1 max-w-2x2 px-4 py-3 bg-white border border-red rounded-md shadow-md dark:bg-gray-800">
