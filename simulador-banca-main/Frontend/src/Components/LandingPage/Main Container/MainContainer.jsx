...
export const MainContainer = () => {
  return (
    <>
      <section class="mx-4 md:mx-12 lg:mx-20 xl:mx-32 grid grid-cols-1 md:grid-cols-3 gap-8">
        <div class="bg-white p-6 rounded-lg shadow-md">
          ...
          />
          <h3 class="text-xl font-semibold mb-2">Cuentas de Nómina</h3>
        ...
        <div class="bg-white p-6 rounded-lg shadow-md">
          ...
          <h3 class="text-xl font-semibold mb-2">Créditos</h3>
          <p class="text-muted-foreground">
        ...
        <div class="bg-white p-6 rounded-lg shadow-md">
          <img
            ...
            className="w-20 mx-auto md:mx-0"
          />
          <h3 class="text-xl font-semibold mb-2">Cuentas de Ahorros</h3>
          <p class="text-muted-foreground">
